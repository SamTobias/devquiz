...
class QuizWidget extends StatefulWidget {
  ...
  final void Function(bool isRight) onSelectAnswer;

  const QuizWidget({Key? key, required this.question, required this.onSelectAnswer}) : super(key: key);
            ...
            AnswerWidget(
              ...
              onTap: () {
                if (answerIndexSelected < 0) {
                  ...
                  Future.delayed(Duration(seconds: 1)).then((value) => widget.onSelectAnswer(answers[i].isRight));
                }
              },
            )
        ],
